...
def total_sales_by_product(data, product_key):
    ...
    for daily_data in data:
        total_sales += daily_data[product_key]
...
def best_selling_day(data):
    ...
    for daily_data in data:
        ...
        total_day_sales = daily_data['product_a'] + daily_data['product_b'] + daily_data['product_c']
...
def average_daily_sales(data, product_key):
    ...
    total_sales = total_sales_by_product(data, product_key)  # Usamos la función anterior
    average_sales = total_sales / len(data)  # Dividir entre el número de días
...
def average_daily_sales(data, product_key):
    ...
    total_sales = total_sales_by_product(data, product_key)  # Usa la función anterior
    average_sales = total_sales / len(data)  # Divide entre el número de días
